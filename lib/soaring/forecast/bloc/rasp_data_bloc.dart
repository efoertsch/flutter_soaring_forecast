...
class RaspDataBloc extends Bloc<RaspDataEvent, RaspDataState> {
  ...
  RaspDataBloc({required this.repository}) : super(InitialRaspDataState());
  ...
  Stream<RaspDataState> mapEventToState(
    ...
    if (event is SelectedRaspModel) {
      ...
      yield* _updateModelDatesAndTimes();
      yield* _getForecastImages();
      return;
    }
...
//    }
  ...
  Stream<RaspDataState> _updateModelDatesAndTimes() async* {
  ...
  Stream<RaspDataState> _getForecastImages() async* {
    String imageUrl;
    ...
    yield (RaspForecastImageSets(_imageSets));
    print("Sent RaspForecastImageSets");
  }
